                    ...
                    <div id="main-content" class="card-body">
                        {{-- <form method="post" action="{{ route('generatePDF',$student->id) }}" enctype="multipart/form-data" autocomplete="off">
                           ...
                           {{-- <hr class="my-4" />  --}}
                                        ...
                                        <table class="table align-items-center table-flush">
                                            ...
                                            <tbody class="list">
                                              ...
                                              <tr>
                                                ...
                                                <td class="text-center" style="width: 15%">
                                                    @if($averageArr['Investigative'] == null)
                                                    <strong>0%</strong>
                                                    @else
                                              ...
                                              <tr>
                                                ...
                                                <td class="text-center" style="width: 15%">
                                                    @if($averageArr['Enterprising'] == null)
                                                    <strong>0%</strong>
                                                    @else
                                              ...
                                              <tr>
                                                ...
                                                <td class="text-center" style="width: 15%">
                                                    @if($averageArr['Conventional'] == null)
                                                    <strong>0%</strong>
                                                    @else
                                ...
                                <div class="col-sm-12">
                                    {{-- <div class="table-responsive"> --}}
                                        <table class="table align-items-center table-flush">
                                            ...
                                            @if(Count($merits) == 0)
                                            <tr>
                                                <td><p>No co-curriculum records</p></td>
                                            </tr>
                                            @else
                            ...
                            <hr class="my-4" /> 
                            <h3 class="heading text-center mt-3 mb-3">Health Records</h3>

                            <div class="row">
                                <div class="col-sm-4">
                                    <h4>This student’s present health is:</h4>
                                </div>
                                <div class="col-sm-3">
                            ...
                            <div class="row">
                                <table class="table align-items-center table-flush">
                                    ...
                                    <tr>
                                        <td style="width: 32%">
                                            <p class="text-default">Height</p>
                                        </td>
                                        <td style="width: 68%">
                                            <p class="text-default">@if($record->height != null){{$record->height}} @else N/A @endif</p>
                                        </td>                                                                                      
                                    </tr>
                                    <tr>
                                        <td style="width: 32%">
                                            <p class="text-default">Weight</p>
                                        </td>
                                        <td style="width: 68%">
                                            <p class="text-default">@if($record->weight != null){{$record->weight}} @else N/A @endif</p>
                                        </td>                                                                                      
                                    </tr>
                                    <tr>
                                        <td style="width: 32%">
                                            <p class="text-default">Health History</p>
                                        </td>
                                            @if($record->health_history != null)
                                                <?php $healthhistory = explode(',',$record->health_history);?>
                                                <td style="width: 68%">
                                                    @foreach($healthhistory as $history)
                                                    <p class="text-default">{{$history}}</p>
                                                    @endforeach
                                                </td>   
                                            @else
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 68%">
                                            <p class="text-default">@if($record->description != null){{$record->description}} @else N/A @endif</p>
                                        </td>                                                                                      
                                    </tr> 
                                    <tr>
                                        <td style="width: 32%">
                                            <p class="text-default">Medication Allergies</p>
                                        </td>
                                        <td style="width: 68%">
                                            <p class="text-default">@if($record->medication_allergies != null){{$record->medication_allergies}} @else N/A @endif</p>
                                        </td>                                                                                      
                                    </tr> 
                                    <tr>
                                        <td style="width: 32%">
                                            <p class="text-default">Medications Now Taking</p>
                                        </td>
                                        <td style="width: 68%">
                                            <p class="text-default">@if($record->medications_now_taking != null){{$record->medications_now_taking}} @else N/A @endif</p>
                                        </td>                                                                                      
                                    </tr> 
                                    <tr>
                                        <td style="width: 32%">
                                            <p class="text-default">Childhood Diseases</p>
                                        </td>
                                        <td style="width: 68%">
                                            <p class="text-default">Chicken pox - @if($record->chicken_pox != null){{$record->chicken_pox}} @else N/A @endif</p>
                                            <p class="text-default">Measles - @if($record->measles != null){{$record->measles}} @else N/A @endif</p>
                                            <p class="text-default">Mumps - @if($record->mumps != null){{$record->mumps}} @else N/A @endif</p>
                                        </td>                                                                                      
                                    </tr> 
                                    @else
                                    <tr>
                                        <td><p>No health records</p></td>
                                    </tr>
                                    @endif
                                    </tbody>
                                </table>
